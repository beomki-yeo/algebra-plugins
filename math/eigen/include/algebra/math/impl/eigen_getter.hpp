...
struct element_getter {
  ...
  /// Get const access to a block element
  template <typename derived_type>
  ALGEBRA_HOST_DEVICE inline auto &operator()(Eigen::Block<derived_type> &m,
...
template <typename derived_type>
ALGEBRA_HOST_DEVICE inline auto &element(Eigen::Block<derived_type> &m, int row,
                                         int col) {
...
struct block_getter {
  ...
  ALGEBRA_HOST_DEVICE auto operator()(matrix_type &m, int row, int col) const {
